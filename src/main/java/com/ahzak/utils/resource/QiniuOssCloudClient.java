...
public class QiniuOssCloudClient {
	...
	public static Map<String, String> uploadFileByLocal(String buckArea, String bucket, String accessKey,
			String secretKey, String ossPath, String localPath) throws RuntimeException {
	...
	public static Map<String, String> uploadFileByByte(String buckArea, String bucket, String accessKey,
			String secretKey, String ossPath, byte[] content) throws RuntimeException {
		Map<String, String> result = new HashMap<String, String>(2);
		UploadManager uploadManager = getUploadManager(buckArea);
		// 默认不指定key的情况下，以文件内容的hash值作为文件名
		String key = ossPath;
	...
	public static boolean uploadFileByInputStream(String buckArea, String bucket, 
			...
			String ossPath, InputStream inputStream) throws RuntimeException {
		Map<String, String> result = new HashMap<String, String>(2);
		UploadManager uploadManager = getUploadManager(buckArea);
		// 默认不指定key的情况下，以文件内容的hash值作为文件名
		String key = ossPath;
	 ...
	 *             RuntimeException
	 */
	public static UploadManager getUploadManager(String bucketArea) throws RuntimeException {
		// 构造一个带指定Zone对象的配置类
...
//		Configuration cfg = getConfiguration(bucketArea);
	 ...
	 */
	public static Configuration getConfiguration(String bucketArea) throws RuntimeException {
		// 构造一个带指定Zone对象的配置类
		...
		if (cfg == null) {
			throw new GlobalException("云存储地区码错误");
		}
		return cfg;
	}
